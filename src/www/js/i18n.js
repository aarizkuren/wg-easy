...
const messages = { // eslint-disable-line no-unused-vars
  ...
  eu: {
    ...
    signIn: 'Saioa hasi',
    logout: 'Saioa amaitu',
    updateAvailable: 'Eguneraketa bat dago!',
    update: 'Eguneratu',
    clients: 'Bezeroak',
    new: 'Berria',
    deleteClient: 'Ezabatu Bezeroa',
    deleteDialog1: 'Ziur zaude ezabatu nahi duzula',
    deleteDialog2: 'Ekintza hau ezin da desegin.',
    cancel: 'Utzi',
    create: 'Sortu',
    createdOn: 'Sortze data ',
    lastSeen: 'Azken ikustaldia ',
    totalDownload: 'Deskarga totala: ',
    totalUpload: 'Igoera totala: ',
    newClient: 'Bezero berria',
    disableClient: 'Bezeroa desgaitu',
    enableClient: 'Bezeroa gaitu',
    noClients: 'Oraindik ez dago bezerorik.',
    noPrivKey: 'Bezero honek ez du giltza pribaturik. Ezin da konfigurazioa sortu.',
    showQR: 'Erakutsi QR Kodea',
    downloadConfig: 'Deskargatu konfigurazioa',
    madeBy: 'Egilea',
    donate: 'Eman',
    toggleCharts: 'Erakutsi/ezkutatu grafikoak',
    theme: { dark: 'Gai iluna', light: 'Gai argia', auto: 'Gai automatikoa' }
  },
};
